...
export class AutoLanding {
  constructor(autopilot, lat, long, flightModel, icao) {
    console.log(`autolanding:`, lat, long, icao);
    this.autopilot = autopilot;
    this.reset(autopilot, lat, long, flightModel, icao);
  }

  /**
   * ...
   */
  reset(autopilot, lat, long, flightModel, icao) {
...
function determineLanding(
  ...
  if (typeof icao === `string`) {
    shortList = [airports.find((e) => e.icao === icao)];
  } else {
